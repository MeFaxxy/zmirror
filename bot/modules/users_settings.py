...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://telegra.ph/file/e208eb2799dd877ad6ea9.jpg"
...
Examples:
1. <code>{escape('<b>Admin: @Faxxy</b>')}</code> 
This will give output as:
<b>Admin: @Faxxy</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @Z_Mirror</code>')}</code> 
This will give output as:
<code>Admin: @Faxxy</code> <code>69MB.bin</code>.
